...
layout (set = 0, binding = 1, input_attachment_index = 0) uniform subpassInput ScenePositionBuffer;
layout (set = 0, binding = 2, input_attachment_index = 1) uniform subpassInput SceneNormalBuffer;

layout (set = 0, binding = 3) uniform sampler2D VarianceShadowMapping;
...
void main()
{
	...
	const vec3 PixelDiffuseLightColor = PixelMaterialColor * DiffuseLightFactor;
